...
public class KASAddonWinchGUI : MonoBehaviour {
  ...
  private GUIStyle guiTooltipStyle;
  ...
  void OnGUI() {
    ...
    guiWindowPos = GUILayout.Window(5501, guiWindowPos, GuiMainWindow, "Winches control",
                                    GUILayout.MinWidth(1), GUILayout.MinHeight(1));
  }
