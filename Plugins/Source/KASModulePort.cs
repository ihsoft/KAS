...
public class KASModulePort : KASModuleAttachCore {
  ...
  public override string GetInfo() {
    ...
    sb.AppendLine();
    sb.AppendFormat("<b>Rotor torque</b>: {0:F1}", rotateForce);
    sb.AppendLine();
    return sb.ToString();
  }
  ...
  [KSPEvent(name = "ContextMenuPlugUndocked", active = true, guiActive = false,
            guiActiveUnfocused = true, guiName = "Plug(Undocked)")]
  public void ContextMenuPlugUndocked() {
    ...
    if (winchModule) {
      ...
      ScreenMessages.PostScreenMessage("You didn't have anything to plug !",
                                       5, ScreenMessageStyle.UPPER_CENTER);
    }
  }

  [KSPEvent(name = "ContextMenuPlugDocked", active = true, guiActive = false,
            guiActiveUnfocused = true, guiName = "Plug(Docked)")]
  ...
  [KSPEvent(name = "ContextMenuUnplug", active = true, guiActive = true,
            guiActiveUnfocused = true, guiName = "Unplug")]
