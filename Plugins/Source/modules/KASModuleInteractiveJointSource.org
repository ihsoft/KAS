...
public sealed class KASModuleInteractiveJointSource : KASModuleLinkSourceBase, IModuleInfo {
  ...
  public override void OnAwake() {
    ...
    // FIXME: create meshes in model prefab and icon prefab
  }
  ...
  Transform idleLinkTargetTransform {
    get {
      if (_idleLinkTargetTransform == null) {
        _idleLinkTargetTransform = new GameObject().transform;
        _idleLinkTargetTransform.parent = nodeTransform;
      }
      return _idleLinkTargetTransform;
    }
  }
  Transform _idleLinkTargetTransform;
