...
public class KASModuleRotor : PartModule {
  ...
  [KSPField(guiActive = true, guiName = "Angle", guiFormat = "F4", guiUnits = "°")]
  public float currentAngle = 0;
  [KSPField(guiActive = true, guiName = "Speed", guiFormat = "F4", guiUnits = "")]
  ...
  public override string GetInfo() {
    ...
    sb.AppendFormat("<b>Speed</b>: {0:F1}", speed);
    sb.AppendLine();
    sb.AppendFormat("<b>Torque</b>: {0:F1}", force);
    sb.AppendLine();
    if (hasLimit) {
      sb.AppendFormat("<b>Minimum angle</b>: {0:F0}", limitMin);
      sb.AppendLine();
      sb.AppendFormat("<b>Maximum angle</b>: {0:F0}", limitMax);
      sb.AppendLine();
    }
  ...
  public override void OnStart(StartState state) {
    ...
    Events["ContextMenuMotorNegative"].guiName =
        negativeWayText + " (" + KASAddonControlKey.rotorNegativeKey + ")";
    Events["ContextMenuMotorPositive"].guiName =
        positiveWayText + " (" + KASAddonControlKey.rotorPositiveKey + ")";
  ...
  public void LoadRotor() {
    ...
    if (firstLoad) {
      ...
      KAS_Shared.DebugLog("LoadRotor - Return rotor to the current position and rotation : "
                          + rotorLocalPos + " | " + rotorLocalRot);
      KAS_Shared.SetPartLocalPosRotFrom(
          rotorTransform.transform, this.part.transform, rotorLocalPos, rotorLocalRot);
    }
    ...
    foreach (String anString in attachNodesSt) {
      ...
      if (an != null) {
        ...
        if (an.attachedPart) {
          KAS_Shared.DebugLog(
              "LoadRotor - Setting rotor joint on : " + an.attachedPart.partInfo.title);
  ...
  [KSPEvent(name = "ContextMenuInvertControl", active = true, guiActive = true,
            guiName = "Invert control")]
  public void ContextMenuInvertControl() {
    controlInverted = !controlInverted;
    RefreshCtrlState();
  }

  [KSPEvent(name = "ContextMenuMotorRelease", active = true, guiActive = true,
            guiName = "Release")]
  public void ContextMenuMotorRelease() {
    MotorRelease();
  }

  [KSPEvent(name = "ContextMenuMotorNegative", active = true, guiActive = true,
            guiName = "Left")]
  ...
  [KSPEvent(name = "ContextMenuMotorPositive", active = true, guiActive = true,
            guiName = "Right")]
  ...
  [KSPEvent(name = "ContextMenuMotorGoto0", active = true, guiActive = true,
            guiName = "Go To 0°")]
  public void ContextMenuMotorGoto0() {
    MotorGoTo(0);
  }

  [KSPEvent(name = "ContextMenuMotorGoto90", active = true, guiActive = true,
            guiName = "Go To 90°")]
  public void ContextMenuMotorGoto90() {
    MotorGoTo(90);
  }

  [KSPEvent(name = "ContextMenuMotorGotoM90", active = true, guiActive = true,
            guiName = "Go To -90°")]
  ...
  [KSPEvent(name = "ContextMenuMotorGoto180", active = true, guiActive = true,
            guiName = "Go To 180°")]
